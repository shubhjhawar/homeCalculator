...
const Form = ({ toggleSummary }) => {
	...
	const handleSubmit = (e) => {
		...
		const emailPayload = {
			...
			hoursRangeStart: formData.hours.hoursRangeStart,
			hoursRangeEnd: formData.hours.hoursRangeEnd,
	...
	if (formSubmitted) {
			...
			<div className="fixed top-0 left-0 w-full h-full z-50 flex justify-center items-center bg-gray-500">
				...
				<div className="absolute top-0 flex flex-col items-center z-20">
					...
					<p className="text-white text-4xl font-bold my-4 ">
						המכרז שלכם התקבל בהצלחה!
					</p>
					<p className="text-white text-xl text-center mb-4">
						אנחנו עובדים קשה לאתר לכם ההצעות משתלמות.
						<br />
						את ההצעות אתם תקבלו ישירות לווצאפ, ותוכלו לבחור את ההצעה
						הטובה ביותר עבורכם.
					</p>
					<button
		...
		return (
			<div
				className={`fixed top-0 left-0 right-0 bottom-0 flex justify-center items-center bg-opacity-50 z-50 bg-slate-900 ${
					formSubmitted ? "bg" : ""
				}`}
			>
				{!formSubmitted && (
								...
								<div className="flex mb-6">
									<div className="mr-8">
										...
										<input
											type="text"
											id="phoneNumber"
											className="border rounded p-1 h-10 w-64 text-right"
									...
									<div>
										...
										<input
											type="text"
											id="fullName"
											className="w-64 h-10 border rounded p-1 text-right"
											placeholder="שם מלא"
								...
								<div className="flex mb-6">
									<div className="mr-8">
										...
										<input
											type="time"
											id="hoursRangeStart"
											className="w-32 h-10 border rounded p-1 text-right"
											value={
												formData.hours.hoursRangeStart
											}
											onChange={handleChange}
										/>
										<input
											...
											id="hoursRangeEnd"
											className="w-32 h-10 border rounded p-1 text-right"
											value={formData.hours.hoursRangeEnd}
											onChange={handleChange}
										/>
									</div>
									<div>
